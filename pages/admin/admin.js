const JUMPSCARE_PRESETS = {
    ...
    async function saveShopStock() {
        ...
        // Delete all current stock using a standard "is not null" equivalent check
    ...
    // ==========================================
    // NEW: Add Avatar to Database Logic
    // ==========================================
    async function addNewItem() {
        ...
        if (error) {
            ...
            // Reload the shop data so the new item shows up in the list above
            loadShopManagementData();
        }
    }
    ...
    function openInventoryModal(userId, username) {
        ...
        const userInv = user.unlocked_avatars || ["default"];
